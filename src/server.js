...
app.post('/webhook/lead', async (req, res) => {
  try {
    ...
    const rowNumber = await logNewLead({
      name, company, phone, email,
      propertyAddress: property_address, isHomeowner: is_homeowner, jobType: job_type, roofAge: roof_age,
      damageType: damage_type, insuranceStatus: insurance_status, timeline, bestTimeToCall: best_time_to_call,
